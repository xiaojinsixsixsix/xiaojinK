<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"4px 5px","borderColor":"#d8dce5","margin":"0 auto","borderWidth":"0 0 1px","width":"calc(100% - 60px)","borderStyle":"solid","height":"34px"}'>
		<scroll-pane ref="scrollPane" class="tags-view-wrapper">
			<div class="tags-view-box" :style='{"width":"100%","whiteSpace":"nowrap","position":"relative"}'>
