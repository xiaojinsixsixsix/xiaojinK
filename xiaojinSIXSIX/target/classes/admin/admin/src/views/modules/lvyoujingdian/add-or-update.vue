	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="官网" prop="guanwang">
					<el-input v-model="ruleForm.guanwang" placeholder="官网" clearable  :readonly="ro.guanwang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="官网" prop="guanwang">
					<el-input v-model="ruleForm.guanwang" placeholder="官网" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="门票价格" prop="menpiaojiage">
					<el-input v-model="ruleForm.menpiaojiage" placeholder="门票价格" clearable  :readonly="ro.menpiaojiage"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="景点介绍" prop="jingdianjieshao">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jingdianjieshao" label="景点介绍" prop="jingdianjieshao">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="注意事项" prop="zhuyishixiang">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zhuyishixiang" label="注意事项" prop="zhuyishixiang">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.zhuyishixiang"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='guanwang'){
							this.ruleForm.guanwang = obj[o];
							this.ro.guanwang = true;
							continue;
						}
						if(o=='menpiaojiage'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jingdianjieshao = this.ruleForm.jingdianjieshao.replace(reg,'../../../xiaojinSIXSIX/upload');
        this.ruleForm.zhuyishixiang = this.ruleForm.zhuyishixiang.replace(reg,'../../../xiaojinSIXSIX/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
